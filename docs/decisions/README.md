...
| [0003](0003-daily-edge-value-scope.md) | Track daily min/max temperature, min/max humidity, min/max pressure, and max wind gust | Proposed |
| [0004](0004-auto-create-database-schema.md) | Auto-create the SQLite database and tables on startup if missing | Proposed |
...
| [0009](0009-rename-tables-and-daily-summary-aggregates.md) | Rename tables; DailySummary gains mean/dominant-direction/accumulated-rain columns | Accepted |
