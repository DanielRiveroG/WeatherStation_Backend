...
| [0002](0002-auto-detect-arduino-serial-port.md) | Auto-detect the Arduino's serial port instead of hardcoding it | Proposed (implemented) |
...
| [0005](0005-web-api-for-live-and-historic-data.md) | Expose a web API for live and historic weather data | Proposed (implemented) |
| [0006](0006-flask-for-web-api.md) | Use Flask for the web API | Accepted (implemented) |
...
| [0010](0010-api-endpoints-and-response-shapes.md) | API endpoint list and response shapes | Revised by 0011, 0013 (implemented) |
| [0011](0011-split-ingestion-and-api-processes.md) | Split ingestion and API into separate processes; live data read from RawReadings | Accepted (implemented) |
